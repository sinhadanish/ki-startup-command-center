...
description: Ki's leadership team, organizational structure, and growth strategy
---
...
<Tabs>
<Tab title="Technical Innovation">
...
<Tab title="Engineering Achievements">
...
<CardGroup cols={2}>
<Card title="Engineering Team (8 people)" icon="code">
...
<Card title="Growth & Marketing Team (3 people)" icon="chart-line">
...
<Card title="Operations Team (2 people)" icon="gear">
...
<Card title="Leadership Team (2 people)" icon="users">
...
<Tabs>
<Tab title="Engineering Organization (25 people)">
...
<Tab title="Product Organization (8 people)">
...
<Tab title="Growth Organization (10 people)">
...
<Tab title="Operations Organization (7 people)">
...
<CardGroup cols={3}>
<Card title="VP Engineering" icon="code">
...
<Card title="Head of Product" icon="lightbulb">
...
<Card title="Head of People & Culture" icon="users">
...
<Tab title="Head of Data Science">
...
<Tab title="Senior AI Engineers (5 positions)">
...
<CardGroup cols={2}>
<Card title="Chief Financial Officer (CFO)" icon="chart-line">
...
<Card title="VP Sales (B2B)" icon="handshake">
...
<Card title="Relationship Focused" icon="handshake">
...
<Card title="Technical Excellence" icon="cog">
...
<Card title="Rapid Learning" icon="chart-line">
...
<Info>
**Track Record Validation**: 50+ years combined experience building successful AI/ML products with previous companies grown from startup to millions of users.
</Info>
