...
description: Comprehensive analysis of the relationship intelligence market opportunity
---
...
<CardGroup cols={2}>
<Card title="Active Therapy Seekers (19%)" icon="user-doctor">
  **11.8M couples**
...
<Card title="Therapy-Priced-Out (35%)" icon="dollar-sign">
  **21.7M couples**
...
<Card title="Preventive Care (20%)" icon="shield-check">
  **12.4M couples**
...
<Card title="Unaware/Unengaged (26%)" icon="eye-slash">
  **16.1M couples**
...
<CardGroup cols={2}>
<Card title="Professional Partnerships (50%)" icon="user-doctor">
...
<Card title="Content Marketing (25%)" icon="content">
...
<Card title="Strategic Partnerships (20%)" icon="handshake">
...
<Card title="Viral Growth (5%)" icon="share">
...
<Info>
**Divorce and Relationship Stress Surge**: 18% increase in divorce rate (2.7 to 3.2 per 1,000), with 2+ million additional divorces projected 2023-2025.
</Info>
...
<Tabs>
<Tab title="Competitive Entry Risk">
...
<Tab title="Consumer Adoption Risk">
...
<Tab title="Economic Sensitivity Risk">
